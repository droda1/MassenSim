...
public class MassenSimulation{
	...
	public MassenSimulation(double x1, double x2, double m1, double m2, double d, double l_gleichgewicht, double v1_start, double v2_start){
        ...
        this.m2= m2;
        this.d= d;
        this.l_gleichgewicht= l_gleichgewicht;
        this.v1= v1_start;
        this.v2= v2_start;
	...
	public void simulate(double absT) {
		...
		double A = x2_start - x1_start-l_gleichgewicht;
		double B = (v2-v1-l_gleichgewicht)/Math.sqrt(m_red/d);
		
		double dt = A*Math.cos(Math.sqrt(d/m_red)*absT)+B * 
				Math.sin(Math.sqrt(d/m_red)*absT)+l_gleichgewicht;
